...
public class ScheduleController {
    ...
    @Operation(summary = "월별 팔로우 전체 일정 조회", description = "팔로우한 모든 아티스트의 특정 월 일정 데이터를 가져와 캘린더에 표시합니다.")
    ...
    @Operation(summary = "개별 아티스트 월별 일정 조회", description = "특정 아티스트를 필터링하여 해당 아티스트의 월별 일정만 표시합니다.")
    ...
    @Operation(summary = "특정 날짜 상세 일정 조회", description = "캘린더에서 특정 날짜를 클릭했을 때, 해당 날짜의 상세 일정 목록을 팝업 형태로 제공합니다.")
    @GetMapping("/daily")
